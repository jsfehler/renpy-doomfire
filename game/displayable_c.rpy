init -998 python in c_doomfire:
    ...
    # Load C++ library.
    if renpy.windows:
        c_lib_name = 'doom_fire_c.dll'
    elif renpy.linux:
        c_lib_name = 'doom_fire_c.so'
    else:
        raise ValueError('Unsupported platform')

    c_lib_path = renpy.loader.transfn(c_lib_name)
    fire_backend = cdll.LoadLibrary(c_lib_path)
